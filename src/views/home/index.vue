<!--
 * @Author: bzirs
 * @Date: 2022-12-15 20:37:40
 * @LastEditors: bzirs
 * @LastEditTime: 2022-12-18 21:20:47
 * @FilePath: /big-event/src/views/home/index.vue
 * @Description:
 *
  ...
  <div>
    ...
    <div class="container-fluid">
      <el-row class="curve-pie" :gutter="10">
        <el-col :sm="16" :xs="16">
          <div class="gragh_pannel" id="curve_show" ref="article"></div>
        </el-col>
        <el-col :sm="8" :xs="8">
...
export default {
  ...
  async created () {},
  mounted () {
    const oChart = echarts.init(this.$refs.article)
    const aListAll = [
